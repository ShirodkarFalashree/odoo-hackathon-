...
const Dashboard = () => {
  return (
    <div className="w-full text-gray-200">
      ...
      <div className="bg-[#111111] p-6 rounded-xl border border-gray-800 items-center mb-10">


      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6 ">

        
        <div className="bg-[#17181C] p-6 rounded-xl border border-gray-800 shadow">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-xl border border-gray-800 shadow xl:col-span-2">
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-xl border border-gray-800 shadow">
      ...
      {/* Table Section */}
      <div className="bg-[#1a1a1a] mt-8 p-6 rounded-xl border border-gray-800 shadow">
        <h2 className="text-xl font-semibold mb-4">Top Category Items</h2>
