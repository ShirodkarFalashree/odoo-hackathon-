...
const Dashboard = () => {
  return (
    <div className="w-full text-white">
      ...
      <div className=" p-6 rounded-xl  shadow-lg bg-[#111111] border-gray-800   items-center mb-10">
      ...
      {/* Table Section */}
      <div className="bg-[#111111] mt-8 p-6 rounded-xl border border-gray-800 shadow">
